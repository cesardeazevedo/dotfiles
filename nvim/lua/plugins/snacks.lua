return {
  {
    ...
    keys = {
      -- Top Pickers & Explorer
      {
        '<leader><space>',
        function()
          Snacks.picker.smart { layout = 'telescope' }
        end,
      ...
      },
      {
        '<leader>p',
        function()
          Snacks.picker.buffers { layout = 'vscode', focus = 'list' }
        end,
        desc = 'Open Buffers',
      },
      {
      ...
      },
      {
        ...
        function()
          Snacks.picker.projects {
            focus = 'list',
            patterns = { '.git', '_darcs', '.hg', '.bzr', '.svn', 'package.json', 'Makefile', 'dune-project' },
          }
        end,
        desc = 'Projects',
      },
